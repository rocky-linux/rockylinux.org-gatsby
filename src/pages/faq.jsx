          ...
          <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
            ...
            <div className="max-w-screen-xl sm:mx-auto">
              <div className="prose mx-auto dark-mode:prose-dark dark:text-gray-300">
                <h5 className="font-bold">If Rocky Linux is just a respin of RHEL, what’s taking so long for a release candidate?</h5>
                <p>If our only goal for Rocky Linux was to debrand and repackage RHEL, we would already be done. However, what we’re trying to do differently is figure out how we can keep Rocky Linux in the hands of the community. Carefully devising this strategy helps make sure that Rocky Linux will never meet the same fate of CentOS.</p>
                <p>The goal is not just to create a community managed RPM based distribution of Linux, but to ensure that it will remain freely available and always in the control of the community, much like Linux itself has. To do that requires more than a build infrastructure; it requires that we put in place the foundational structures that enable the community, ensuring that Rocky Linux is forever inclusive, free, and open. The infrastructure is built from the ground up by many collaborators and sponsoring organizations around composability and security compliance, providing the substrate for not only the base operating system but also an entire community of diverse interests to take part in the project.</p>
                <hr />
                <h5 className="font-bold">If you’re not just repackaging RHEL, then what exactly are you doing?</h5>
                <p>Our goal is to maintain Rocky Linux as a community-oriented distribution <i>by</i> the community, <i>for</i> the community.  To do this, we are establishing the necessary organizational structures to ensure that Rocky Linux remains in the hands of the community. We want to make sure that it’s not possible for what happened to CentOS to happen to Rocky Linux.</p>
                <hr />
                <h5 className="font-bold">How will you ensure that Rocky Linux truly remains a community enterprise operating system?</h5>
                ...
                <hr />
                <h5 className="font-bold">What infrastructure is necessary to enable the community?</h5>
                <p>We’ve established a number of teams to support the various efforts associated with developing Rocky Linux:</p>
                <ul>
                  <li>Community</li>
