        ...
        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          ...
          <div className="max-w-screen-xl sm:mx-auto">
            <div className="prose mx-auto dark-mode:prose-dark dark:text-gray-300">
              ...
              <p>
                <a href="https://rockylinux.org/download">https://rockylinux.org/download</a>
              </p>
              <hr />
              <h5 className="font-bold">
              ...
              <p>
              Please email <a href="mailto:mirrors@rockylinux.org">mirrors@rockylinux.org</a> to express your interest.
              </p>
              <hr />
              <h5 className="font-bold">
              ...
              <p>
              Please join the <a href="https://chat.rockylinux.org/rocky-linux/channels/testing">~Testing</a> channel on our Mattermost server to get started. There’s also a testing topic on the forums for more durable conversation.
              </p>
              <hr />
              <h5 className="font-bold">
              ...
              <p>
              Please email us: <a href="mailto:hello@rockylinux.org">hello@rockylinux.org</a> and we’ll get back to you as soon as we can.
              </p>
            </div>
          </div>
        </div>
