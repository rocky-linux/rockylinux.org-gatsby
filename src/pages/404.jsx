    ...
    <Layout>
      ...
      <div className="max-w-4xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
        ...
        <h2 className="text-black dark:text-white">
          ...
          <span className="block text-3xl sm:text-6xl">{translate('errors.404.title')}</span>
        </h2>
        <p className="mt-7 text-2xl leading-6 text-black dark:text-white">{translate('errors.404.explanation')}</p>
