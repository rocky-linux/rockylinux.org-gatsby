...
const NotFoundPage = () => (
  <Layout>
    ...
    <div className="max-w-4xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
      <svg className="text-green-500 w-full items-center justify-center" xmlns="http://www.w3.org/2000/svg"
      ...
      <h2 className="text-black dark:text-white">
        ...
        <span className="block text-3xl sm:text-6xl">Page not found.</span>
      </h2>
      <p className="mt-7 text-2xl leading-6 text-black dark:text-white">The requested resource couldn't be located. Please check the URL and try again.</p>
      <Link to="/"
