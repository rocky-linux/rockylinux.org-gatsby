      ...
      <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        <nav className="-mx-5 -my-2 flex flex-wrap justify-center" aria-label="Links" dir="auto">
          <div className="px-5 py-2">
            <a href="https://wiki.rockylinux.org/contributing" className="text-base text-gray-600 dark:text-gray-400 hover:text-gray-500 dark:hover:text-white">
          ...
          <div className="px-5 py-2">
            <LocalizedLink to="/press/" className="text-base text-gray-600 dark:text-gray-400 hover:text-gray-500 dark:hover:text-white">
        ...
        <div className="mt-8 flex justify-center space-x-6">
          ...
          <a href="https://chat.rockylinux.org/" className="text-gray-600 dark:text-gray-400 hover:text-gray-500 dark:hover:text-white">
            ...
            <svg className="h-6 w-6" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 38 31"><path d="M16.109 0C9.396-.047 3.12 4.167.849 10.869c-2.833 8.371 1.656 17.448 10.02 20.281 8.371 2.833 17.448-1.656 20.281-10.02 2.303-6.803-.229-14.068-5.749-18.079l.172 3.396c2.749 3.041 3.839 7.349 2.468 11.401-2.047 6.041-8.791 9.219-15.068 7.093-6.276-2.125-9.708-8.745-7.661-14.792 1.376-4.057 4.876-6.828 8.928-7.557L16.427.004c-.104-.005-.213-.005-.323-.005zm4.703 1.459a.471.471 0 00-.167.031h-.005a.556.556 0 00-.145.099c-.192.188-.875 1.105-.875 1.105l-1.484 1.837-1.735 2.115-2.98 3.704s-1.364 1.703-1.061 3.801c.301 2.1 1.859 3.12 3.072 3.532 1.208.405 3.068.541 4.584-.943 1.515-1.48 1.463-3.667 1.463-3.667l-.115-4.745-.093-2.735-.063-2.364s.011-1.141-.025-1.412a.698.698 0 00-.047-.14l-.011-.016-.005-.016a.39.39 0 00-.308-.187z" /></svg>
          </a>
        ...
        <nav className="mt-5 flex flex-wrap justify-center" aria-label="Language">
          <div className="px-5 py-2 flex">
            ...
            <noscript className="mt-8 text-center text-base text-gray-500">JavaScript appears to be disabled in your browser. The language picker will not function without JavaScript, but you can append your language code to the URL to access a supported language. For example, "https://rockylinux.org/tr/".</noscript>
          </div>
        </nav>
