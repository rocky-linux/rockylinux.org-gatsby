      ...
      render={(data) => (
        <div className="pt-16 pb-20 px-4 sm:px-6 lg:pt-24 lg:pb-28 lg:px-8">
          <div className="relative max-w-lg mx-auto divide-y-2 divide-gray-200 lg:max-w-7xl">
            <div>
              <h2 className="font-display text-3xl tracking-tight font-medium text-gray-900 dark:text-gray-50 sm:text-4xl">
            ...
            <div className="mt-12 grid gap-16 pt-12 lg:grid-cols-3 lg:gap-x-5 lg:gap-y-12">
              {data.allMarkdownRemark.edges.map((post) => (
                <div key={post.node.fields.slug}>
                  ...
                  >
                    <p className="font-display text-xl font-semibold text-gray-900 dark:text-gray-400">
