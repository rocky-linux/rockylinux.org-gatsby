        ...
        <div className="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
          <div className="relative flex items-center justify-between">
            ...
            <div className="lg:hidden">
              <button aria-label="Open Menu" title="Open Menu" onClick={() => setIsOpen(!isOpen)} className="p-2 -mr-1 transition duration-200 rounded focus:outline-none focus:shadow-outline">
                ...
                <div className="absolute top-0 left-0 w-full z-50">
                  <div className="p-5 bg-white dark:bg-gray-800 border dark:border-gray-700 rounded shadow-sm">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div>
                        <button aria-label="Close menu" onClick={() => setIsOpen(!isOpen)} title="Close menu" className="p-2 -mt-2 -mr-2 transition duration-200 rounded hover:bg-gray-200 focus:bg-gray-200 dark:hover:bg-gray-700 dark:focus:bg-gray-700 focus:outline-none focus:shadow-outline">
                          <svg className="w-5 text-gray-600 dark:text-white" viewBox="0 0 24 24">
                    ...
                    <nav>
                      <ul className="space-y-4">
                        <li><Link to="/news/" aria-label="News" title="News" className="font-medium tracking-wide text-gray-700 dark:text-white transition-colors duration-200 hover:text-green-500">News</Link></li>
