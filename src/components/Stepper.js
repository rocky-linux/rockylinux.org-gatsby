    ...
    return (
      ...
      >
        <div className="relative flex flex-col items-center">
          <div
            className={`rounded-full transition duration-500 ease-in-out h-12 w-12 flex items-center justify-center py-3 ${
              v.status == 'done'
                ...
                : 'dark:border-gray-700 border-gray-300 border-2 dark:text-gray-300 text-gray-800 dark:bg-gray-900 bg-white'
            } font-bold`}
          >
          ...
          <div
            className={`absolute top-0 text-center mt-14 w-32 font-medium ${
              v.status == 'done'
                ? 'text-green-500'
                : v.status == 'doing'
                ? 'text-blue-500'
